...
Verification context: exact gpt-5.4 requests now canonicalize to codex/gpt-5.4 instead of drifting into OpenRouter, while Gemini routing and shared 429 cooldown coordination remain intact
