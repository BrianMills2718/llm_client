...
Verification context: exact gpt-5.4 requests now canonicalize to codex/gpt-5.4 in replayable routing traces through the typed provider-governance policy, while shared 429 cooldown coordination still avoids duplicate retry waits and cooldown busy-spins across worktrees through the backend boundary
