...
Verification context: exact gpt-5.4 requests now canonicalize to codex/gpt-5.4 instead of OpenRouter drift, and shared 429 cooldown coordination still avoids duplicate retry waits or cooldown busy-spins
