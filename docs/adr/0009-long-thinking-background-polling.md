...
Verification context: exact gpt-5.4 requests now canonicalize through the typed provider-governance policy instead of OpenRouter drift, and shared 429 cooldown coordination still avoids duplicate retry waits or cooldown busy-spins through the provider-coordination backend
