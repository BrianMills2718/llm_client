...
Verification context: exact gpt-5.4 requests now resolve to codex/gpt-5.4 in routing traces through the typed provider-governance policy, while Gemini routing and shared cooldown behavior remain intact through the coordination backend boundary
