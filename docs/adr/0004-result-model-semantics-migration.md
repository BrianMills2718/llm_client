...
Verification context: exact gpt-5.4 requests now resolve to codex/gpt-5.4 in routing traces instead of OpenRouter drift, while Gemini routing and shared 429 cooldown coordination remain intact
