...
| 24 | [Workflow Kit Manifest, Validator, and Runtime Adapter Proving Slice](24_workflow-kit-manifest-validator-and-runtime-adapter-proving-slice.md) | High | 📋 Planned | truthful workflow packaging and any later installer/registry work |
