...
| 24 | [Workflow Kit Manifest, Validator, and Runtime Adapter Proving Slice](24_workflow-kit-manifest-validator-and-runtime-adapter-proving-slice.md) | — | ↪ Redirected | Execution strategy layer → agentic_scaffolding; packaging → PROJECTS_DEFERRED. See project-meta ADR-2026-04-04-workflow-portability-revised. |
