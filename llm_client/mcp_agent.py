...
def _apply_agent_loop_metadata(
    *,
    ...
    autofilled_tool_reasoning_calls: int,
    ...
    """Populate agent_result metadata and derived warning rollups."""
    _apply_agent_loop_metadata(
        ...
        autofilled_tool_reasoning_calls=autofilled_tool_reasoning_calls,
        autofilled_tool_reasoning_by_tool=autofilled_tool_reasoning_by_tool,
