...
from llm_client.cli.adoption import cmd_adoption, register_parser as register_adoption_parser
...
from llm_client.cli.tools import cmd_tools, register_parser as register_tools_parser
